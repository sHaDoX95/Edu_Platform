...
// Проверяем, является ли преподаватель владельцем курса
$isCourseOwner = false;
if ($user['role'] === 'teacher') {
    $isCourseOwner = Course::isOwner($user['id'], $course['id']);
}
...
<body>
    ...
    <div class="container">
        ...
        <div class="course-header">
            ...
            <?php if ($user['role'] === 'teacher' && !$isCourseOwner): ?>
                <div class="alert alert-info">
                    ℹ️ Вы просматриваете этот курс, но не являетесь его владельцем
                </div>
            <?php endif; ?>
        </div>
